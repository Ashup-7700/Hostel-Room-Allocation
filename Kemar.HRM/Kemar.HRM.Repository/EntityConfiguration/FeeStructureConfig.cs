...
{
    internal class FeeStructureConfig : BaseEntityConfig<FeeStructure>, IEntityTypeConfiguration<FeeStructure>
    {
        public override void Configure(EntityTypeBuilder<FeeStructure> builder)
        {
            base.Configure(builder);

            builder.Property(f => f.FeeStructureId).ValueGeneratedOnAdd();
            builder.Property(f => f.RoomType).IsRequired().HasMaxLength(100);
